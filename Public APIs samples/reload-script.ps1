...
$contentDispositionHeaderValue.FileName = $scriptFile

$fileStream = New-Object System.IO.FileStream @($scriptFile, [System.IO.FileMode]::Open)
...
try
{
  Write-Host "going to reload script #$scriptId with file: '$scriptFile'"
